...
const handleUnclaimButton = async (interaction) => {
    ...
    const dm = await interaction.client.channels.fetch(interaction.channelId);
    const message = await dm.messages.fetch(interaction.message.id);
